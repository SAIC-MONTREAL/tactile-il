...
ID="apr12-first-try"
DATA_DIR_NAMES=(
    'PandaTopBlackFlatHandleTactileOnly/double_env_lower_max_fix'
    'PandaTopBlackFlatHandleCloseTactileOnly/double_env_lower_max_fix'
    'PandaTopBlackFlatHandleVisualOnly/double_env_lower_max_fix'
    'PandaTopBlackFlatHandleCloseVisualOnly/double_env_lower_max_fix'
)
