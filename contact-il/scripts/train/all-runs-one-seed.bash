...
MAIN_VARIANT_STRS=(
    ...
    "${data_dir_sub_strs[2]} ${obs_list_strs[0]}"
    "${data_dir_sub_strs[0]} ${obs_list_strs[2]}"
    "${data_dir_sub_strs[1]} ${obs_list_strs[2]}"
    "${data_dir_sub_strs[2]} ${obs_list_strs[2]}"
...
for pre_data_str in "${pre_data_strs}"; do
    combined=("${MAIN_VARIANT_STRS[@]}" "${OBS_VARIANT_STRS[@]}")
